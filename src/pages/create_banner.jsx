...
const Create_Banner = () => {
  ...
  const create_banner = async (event) => {
    ...
    try {
        const response = await axios.post(`https://travel-journal-api-bootcamp.do.dibimbing.id/api/v1/create-banner`, payload, {
          headers: {
  ...
  return (
    ...
    <div className="page">
      <section className="input-parent">
        ...
        <button onClick={create_banner} className="button-fill" type="submit">Create</button>
        </form>
      </section>
    </div>
    </div>
